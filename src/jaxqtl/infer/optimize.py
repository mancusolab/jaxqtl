...
from jax import Array, numpy as jnp  # , lax
...
#         likelihood_o = family.loglikelihood(X, y, eta_o, alpha_o)
#         likelihood_n = family.loglikelihood(X, y, eta_n, alpha_o)
#         diff = likelihood_n - likelihood_o
#
#         mu_n = family.glink.inverse(eta_n)
#         alpha_n = family.calc_dispersion(y, mu_n, alpha_o)
#
...
#     init_tuple = (10000.0, 0, init_beta, eta + offset_eta, 1.0)
#
