...
from .distribution._expfam import ExponentialFamily, NegativeBinomial
...
def simulate_pheno(
    ...
    r"""Simulate phenotype data under a GLM with a supplied [`jaxqtl.distribution.ExponentialFamily`][].
    ...
    **Arguments:**
    ...
    - `dispersion`: Optional dispersion/scale parameter. If `None`, defaults to `0.1` for
      [`jaxqtl.distribution.NegativeBinomial`][] and `1.0` otherwise.
