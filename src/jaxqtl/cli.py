...
def _main(args):
    parser = ap.ArgumentParser(description="jaxqtl: GPU-based QTL mapper")
    ...
    parser.add_argument("-o", "--output_prefix", default=".", help="Output directory")
    ...
    log = get_logger(__name__, args.output_prefix)
    if args.verbose:
